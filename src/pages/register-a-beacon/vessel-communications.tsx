...
const VesselCommunications: FunctionComponent<DraftBeaconUsePageProps> = ({
  ...
  return (
    <BeaconsForm
      previousPageUrl={
        CreateRegistrationPageURLs.aboutTheVessel + queryParams({ useIndex })
      }
...
export const getServerSideProps: GetServerSideProps = withContainer(
  withSession(async (context: BeaconsGetServerSidePropsContext) => {
    ...
    return await new BeaconsPageRouter([
      ...
      new GivenUserViewedRegistrationFormWithoutSubmitting_ShowFormWithoutErrors<VesselCommunicationsForm>(
        context,
        validationRules,
        mapper(context),
        props(context)
