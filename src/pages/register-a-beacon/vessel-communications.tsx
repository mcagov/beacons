...
import { nextPageWithUseIndexHelper } from "../../lib/nextPageWithUseIndexHelper";
import {
...
const VesselCommunications: FunctionComponent<DraftBeaconUsePageProps> = ({
  ...
  return (
    <BeaconsForm
      previousPageUrl={
        CreateRegistrationPageURLs.aboutTheVessel + queryParams({ useId })
      }
