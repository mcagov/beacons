  ...
  "Statement": [
    {
      ...
      "Resource": ["${aws_secretsmanager_secret.db_password.arn}", "${aws_secretsmanager_secret.gov_notify_api_key.arn}", "${aws_secretsmanager_secret.gov_notify_customer_email_template.arn}", "${aws_secretsmanager_secret.basic_auth.arn}"]
    }
  ]
}
EOF
