package uk.gov.mca.beacons.api.search.specifications;
...
public class BeaconSearchSpecification {
  ...
  public static @Nullable Specification<BeaconSearchEntity> hasCospasSarsatNumber(
  ...
  public static @Nullable Specification<BeaconSearchEntity> hasManufacturerSerialNumber(
