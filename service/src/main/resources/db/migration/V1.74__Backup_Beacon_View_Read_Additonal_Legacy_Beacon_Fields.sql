...
SELECT * FROM (
      ...
      SELECT
          ...
          (legacy_beacon.data->'beacon'->>'batteryExpiryDate')::date as battery_expiry_date,
          (legacy_beacon.data->'beacon'->>'last_serviced_date')::date as last_serviced_date,
          ...
          (legacy_beacon.data->'beacon'->>'svdr')::boolean as svdr,
