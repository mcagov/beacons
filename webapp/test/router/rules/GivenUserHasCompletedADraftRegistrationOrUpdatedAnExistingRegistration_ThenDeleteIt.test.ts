...
import { GivenUserHasCompletedADraftRegistrationOrUpdatedAnExistingRegistration_ThenDeleteIt } from "../../../src/router/rules/GivenUserHasCompletedADraftRegistrationOrUpdatedAnExistingRegistration_ThenDeleteIt";
...
describe("GivenUserHasCompletedADraftRegistrationOrUpdatedAnExistingRegistration_ThenDeleteIt", () => {
  describe("condition()", () => {
