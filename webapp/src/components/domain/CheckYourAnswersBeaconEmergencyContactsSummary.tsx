...
export const CheckYourAnswersBeaconEmergencyContactsSummary: FunctionComponent<
  CheckYourAnswersBeaconEmergencyContactsSummaryProps
> = ({
  registration,
  changeUrl,
    ...
    <>
      ...
      <SummaryList>
        ...
        >
          ...
          <DataRowItem value={registration.emergencyContact1TelephoneNumber} />
          <DataRowItem
        ...
        >
          ...
          <DataRowItem value={registration.emergencyContact2TelephoneNumber} />
          <DataRowItem
        ...
        >
          ...
          <DataRowItem value={registration.emergencyContact3TelephoneNumber} />
          <DataRowItem
