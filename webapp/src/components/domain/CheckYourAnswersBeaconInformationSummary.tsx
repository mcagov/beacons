...
export const CheckYourAnswersBeaconInformationSummary: FunctionComponent<
  CheckYourAnswersBeaconInformationSummaryProps
> = ({
  registration,
  changeUrl,
  ...
  <>
    <SummaryList>
      ...
      >
        ...
        />
        <DataRowItem label="CHK (checksum) code" value={registration.chkCode} />
