...
export const CheckYourAnswersBeaconUseSummary: FunctionComponent<
  CheckYourAnswersBeaconUseSummaryProps
...
const AboutTheVesselSubSection: FunctionComponent<
  CheckYourAnswersBeaconUseSummaryProps
> = ({ index, use }: CheckYourAnswersBeaconUseSummaryProps): JSX.Element => {
...
const AboutTheAircraftSubSection: FunctionComponent<
  CheckYourAnswersBeaconUseSummaryProps
> = ({ index, use }: CheckYourAnswersBeaconUseSummaryProps): JSX.Element => {
...
const CommunicationsSubSection: FunctionComponent<
  CheckYourAnswersBeaconUseSummaryProps
> = ({
  index,
  use,
...
const MoreDetailsSubSection: FunctionComponent<
  CheckYourAnswersBeaconUseSummaryProps
> = ({ index, use }: CheckYourAnswersBeaconUseSummaryProps): JSX.Element => {
